...
export default function ProjetosDeLeiContent() {
  ...
  function getChartTitle() {
    ...
    const [start, end] = mandato.split(';');
    if (onlyApproved) {
      return `Projetos de Lei Aprovados entre ${start} - ${end}: ${total}`;
    }
    return `Projetos de Lei Propostos entre ${start} - ${end}: ${total}`;
  }
